...
<div id="content" >
  <div id="sign_up">
    <div id="sign_right" style="clear:both; float:right; height:314px; width:610px;">
      <div class="leftsignup" style="float:left; margin-left:15px; margin-top:120px; width:295px;"> <a href="./redirect.php"><img src="images/twitter_sign.png" alt="Sign Up With Twitter Here"  /></a> </div>
...
session_start();
 ...
 if ($user): ?>
        ...
        <?php else: ?>
            <div>
                <a href="<?php echo $loginUrl; ?>"> <img src="images/facebook_sign.png" alt="Login with Facebook"  /></a>
            </div>
        <?php endif ?>
