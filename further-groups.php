<?
	...
	if($_REQUEST['parentGroup'] == 'Gang'){
		$groupName	=	'My Gang';
	}else{
		$groupName	=	$_REQUEST['parentGroup'];
	}	
	$q = "SELECT * FROM tbl_groups WHERE group_type = '".$groupName."'";
	$q1 = "SELECT count( * ) as total FROM tbl_groups WHERE group_type = '".$groupName."'";
...
<div id="content">
   <div id="banner">
	...
	<h2><span>All Groups In </span> <?=$groupName?> </h2>     
    <h3><?=$groupName?> List</h3>
   </div>
   <div class="clear"></div>
